...
public final class CommandUtil {
  ...
  public static @NonNull Player resolvePlayer(
      ...
      sender.sendMessage(
        MiniMessage
          ...
          .deserialize(
            ...
            Placeholder.unparsed("input", selector.getSelector())
          )
      );
      throw new CompletedSuccessfullyException();
    }
  ...
  public static @NonNull RichDescription description(
    final @NonNull String miniMessage
  ) {
    return RichDescription.of(
